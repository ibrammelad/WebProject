...
<body>
<form action="{{url('/review-doctors')}}"  class="form-group">
	<h2 class="form-group-h2">admin login: </h2>
	<span class="form-group-span fa fa-user "> username:</span>
	<input class="form-group-input" type="text" name="username" placeholder="enter your username">
	<br>
	...
	<button class="form-group-button" type="submit" name="submit">login</button>
</form>
</body>
</html>